...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [326],
  {
    ...
    8326: function (e, t, r) {
      ...
      function linkClicked(e, t, r, n, a, l, u, s, c, f) {
        let { nodeName: d } = e.currentTarget,
          p = 'A' === d.toUpperCase();
        if (p && (isModifiedEvent(e) || (!c && !(0, i.isLocalURL)(r)))) return;
        e.preventDefault();
        let navigate = () => {
          let e = null == u || u;
          'beforePopState' in t
      ...
      let y = o.default.forwardRef(function (e, t) {
          ...
          let x = o.default.useContext(c.RouterContext),
            M = o.default.useContext(f.AppRouterContext),
            w = null != x ? x : M,
            U = !x,
            C = !1 !== y,
            k = null === y ? g.PrefetchKind.AUTO : g.PrefetchKind.FULL,
            { href: L, as: I } = o.default.useMemo(() => {
              if (!x) {
                let e = formatStringOrUrl(i);
                return { href: e, as: l ? formatStringOrUrl(l) : e };
              }
              let [e, t] = (0, a.resolveHref)(x, i, !0);
              return { href: e, as: l ? (0, a.resolveHref)(x, l) : t || e };
            }, [x, i, l]),
            T = o.default.useRef(L),
            A = o.default.useRef(I);
          N && (n = o.default.Children.only(r));
          let W = N ? n && 'object' == typeof n && n.ref : t,
            [D, z, K] = (0, d.useIntersection)({ rootMargin: '200px' }),
            F = o.default.useCallback(
              (e) => {
                (A.current !== I || T.current !== L) &&
                  (K(), (A.current = I), (T.current = L)),
                  D(e),
                  W &&
                    ('function' == typeof W
                      ? W(e)
          ...
          o.default.useEffect(() => {
            w && z && C && prefetch(w, L, I, { locale: O }, { kind: k }, U);
          }, [I, L, z, O, C, null == x ? void 0 : x.locale, w, U, k]);
          let Q = {
            ref: F,
            onClick(e) {
              N || 'function' != typeof _ || _(e),
                ...
                w &&
                  !e.defaultPrevented &&
                  linkClicked(e, w, L, I, R, P, v, O, U, C);
            },
            onMouseEnter(e) {
          ...
          if ((0, u.isAbsoluteUrl)(I)) Q.href = I;
          else if (!N || b || ('a' === n.type && !('href' in n.props))) {
            ...
            Q.href =
              t ||
              (0, h.addBasePath)(
                (0, s.addLocale)(I, e, null == x ? void 0 : x.defaultLocale),
              );
          }
          return N
            ? o.default.cloneElement(n, Q)
            : o.default.createElement('a', { ...j, ...Q }, r);
        }),
        b = y;
      ('function' == typeof t.default ||
        ('object' == typeof t.default && null !== t.default)) &&
    ...
    1581: function (e, t, r) {
      ...
      function createObserver(e) {
        ...
        return (
          (t = { id: r, observer: a, elements: o }), l.push(r), i.set(r, t), t
        );
      }
      function observe(e, t, r) {
        let { id: n, observer: o, elements: a } = createObserver(r);
        return (
          a.set(e, t),
          o.observe(e),
          function () {
    ...
    4586: function (e, t, r) {
          ...
          parameterizedRoute: t
            .map((e) => {
              let t = n.INTERCEPTION_ROUTE_MARKERS.find((t) => e.startsWith(t)),
                a = e.match(/\[((?:\[.*\])|.+)\]/);
              if (t && a) {
                let { key: e, optional: n, repeat: l } = parseParameter(a[1]);
                return (
                  (r[e] = { pos: i++, repeat: l, optional: n }),
                  '/' + (0, o.escapeStringRegexp)(t) + '([^/]+?)'
                );
              }
              if (!a) return '/' + (0, o.escapeStringRegexp)(e);
              {
                let { key: e, repeat: t, optional: n } = parseParameter(a[1]);
                return (
      ...
      function getSafeKeyFromSegment(e) {
        let { getSafeRouteKey: t, segment: r, routeKeys: n, keyPrefix: o } = e,
          { key: a, optional: i, repeat: l } = parseParameter(r),
          u = a.replace(/\W/g, '');
        o && (u = '' + o + u);
        let s = !1;
        return (
      ...
      function getNamedMiddlewareRegex(e, t) {
        ...
        let { namedParameterizedRoute: o } = getNamedParametrizedRoute(e, !1);
